    ...
    >
      <div className="w-full h-full flex-1 flex flex-col justify-between gap-5 max-w-md mx-auto">
        ...
        >
          ...
          <span className="text-3xl sm:text-4xl font-bold tracking-tight">{t("I need help")}</span>
        </motion.button>
        ...
        >
          ...
          <span className="text-3xl sm:text-4xl font-bold tracking-tight">{t("I'm fine")}</span>
        </motion.button>
      </div>
    </motion.div>
  );
